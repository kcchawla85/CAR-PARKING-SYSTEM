...
void delete_record()
{
	...
	cin>>n;
	ifstream inFile;
    inFile.open("parking3.txt", ios::binary);
	ofstream outFile;
    outFile.open("temp.text", ios::out | ios::binary);
    ...
    remove("parking3.text");
    rename("temp.text", "parking3.text");
}
     ...
     switch(choice)
     {
      case 1 :
        {		
				...
				ofstream f1("parking3.text",ios::binary|ios::out|ios::app);
                a.input();
       ...
       case 2 :
           ...
           cout << "\n";
           ifstream infile("parking3.text",ios::binary|ios::in);
           int d=1;
